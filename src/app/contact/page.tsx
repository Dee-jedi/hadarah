      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-12">
        ...
        <div className="mt-20 flex flex-col items-center justify-center">
          ...
          <div className="flex items-center gap-6">
            <a href="#" className="w-12 h-12 flex items-center justify-center bg-white border border-gray-200 rounded-full text-gray-600 hover:text-[#C5A059] hover:border-[#C5A059] transition-all hover:shadow-lg hover:-translate-y-1">
